...
switch(tipo){
    ...
    case 'feed-radios':
            new Vue({
                el:'#app',
                render: h => h(Ivoxradio, {props:{tipo:tipo,listaFeed: listaFeed, data:data, validez: validez}}) 
            })
        break;
    case 'feed-noticias':
            new Vue({
                el:'#app',
                render: h => h(Noticias, {props:{tipo:tipo,listaFeed: listaFeed, data:data, validez: validez}}) 
